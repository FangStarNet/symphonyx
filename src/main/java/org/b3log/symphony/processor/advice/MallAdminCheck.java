...
/**
 * Mall admin check. Gets user from request attribute named "user" if logged in.
 *
 * @author <a href="http://88250.b3log.org">Liang Ding</a>
 * @version 1.0.0.0, Mar 2, 2015
 * @since 1.4.0
 */
@Named
@Singleton
public class MallAdminCheck extends BeforeRequestProcessAdvice {

    /**
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(MallAdminCheck.class.getName());
    ...
    public void doAdvice(final HTTPRequestContext context, final Map<String, Object> args) throws RequestProcessAdviceException {
        ...
        try {
            ...
            if (!Role.ADMIN_ROLE.equals(role) && !UserExt.MALL_ADMIN_ROLE.equals(role)) {
                throw new RequestProcessAdviceException(exception);
            }

            request.setAttribute(User.USER, currentUser);
        } catch (final ServiceException e) {
            LOGGER.log(Level.ERROR, "Mall admin check failed");
